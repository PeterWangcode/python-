...
class JudgeStr:
    def judge_str(self, string: str) -> bool:
        ...
        true_list = ["Python", "Java", "MachineLearning", "DataMining"]  # 四个特殊单词
